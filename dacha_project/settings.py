...
SECRET_KEY = 'django-insecure-#^10u^s0)jf%$dl6rmfv-aa$mzua+wmgq!(_wp)2^v71(erg%x'
...
# Media files (Загрузка картинок пользователями)
MEDIA_URL = '/media/'
...
# Используем нашу модель пользователя из core
